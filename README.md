...
This repository contains the exam project for the course Grundlæggende Data Science (GDS) at the University of Copenhagen (UCPH). The project focuses on the detection of fake news.
